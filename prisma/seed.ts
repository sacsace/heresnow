...
async function upsertTier(
  ...
  const priceAmount = pricePerUser * maxSeats;
  return prisma.pricingTier.upsert({
    ...
    update: { priceAmount, pricePerUser, label, sortOrder, currency: "INR", trialDays },
  });
}
...
async function main() {
  ...
  const t1 = await upsertTier(1, 20, 75, "1–20명 (연)", 1, "YEARLY", null);
  await upsertTier(21, 50, 40, "21–50명 (연)", 2, "YEARLY", null);
  await upsertTier(51, 80, 31, "51–80명 (연)", 3, "YEARLY", null);
  await upsertTier(81, 100, 30, "81–100명 (연)", 4, "YEARLY", null);
  await upsertTier(1, 20, 8, "1–20명 (월)", 10, "MONTHLY", null);
  await upsertTier(21, 50, 4, "21–50명 (월)", 11, "MONTHLY", null);
  await upsertTier(51, 80, 3, "51–80명 (월)", 12, "MONTHLY", null);
  await upsertTier(81, 100, 3, "81–100명 (월)", 13, "MONTHLY", null);
