 ...
 * 데스크톱에서는 자동으로 숨겨진다 (sm: 이상에서 hidden).
 */
    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          />
          <aside className="absolute inset-y-0 left-0 flex w-[min(20rem,82vw)] max-w-full flex-col bg-[var(--background)] pb-[env(safe-area-inset-bottom,0px)] pt-[env(safe-area-inset-top,0px)] shadow-2xl">
